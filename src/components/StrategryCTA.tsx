...
const StrategyCTAForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch('/api/send-email', {
        ...
        body: JSON.stringify({ ...formData, captchaToken, formName: 'Strategy & Operations' })
      });
      if (!res.ok) {
  ...
  return (
    <section className="relative overflow-hidden bg-slate-900 py-20 lg:py-28 font-sans text-white scroll-mt-24 lg:scroll-mt-28" id="strategy-cta-form">
          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="space-y-4">
              ...
              <h2 className="text-4xl lg:text-5xl font-bold tracking-tight text-white leading-tight">
                Ready to <span className="text-[#14C1F4] bg-clip-text text-transparent bg-gradient-to-r from-[#14C1F4] to-blue-400">Consult, Optimize,</span> or Transform Operations?
              </h2>
              <p className="text-slate-300 text-lg leading-relaxed font-medium">
                Partner with our consulting team to streamline procurement, optimize supply chains, manage change, and implement administrative support systems.
              </p>
            </div>
          </div>
                ...
                {isSubmitted ? (
                  ...
                  <div className="py-16 text-center flex flex-col items-center justify-center min-h-[480px]">
                    ...
                    <p className="text-slate-600 max-w-sm mx-auto text-sm leading-relaxed mb-8">
                      Thank you, <span className="text-[#14C1F4] font-bold">{formData.name}</span>. Our operations consulting team will review your request for <span className="font-bold text-slate-900">{formData.organization}</span> and reach out to you shortly.
                    </p>
                    <button
                      onClick={() => {
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                      <h3 className="text-xl font-bold text-slate-900">Connect with our Operations Consultants</h3>
                      <p className="text-xs text-slate-500 mt-1">Please fill in the details below, and our operations consultants will connect with you.</p>
                    </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <textarea
                        ...
                        onChange={handleChange}
                        placeholder="Tell us about your procurement challenges, change management needs, or logistics goals..."
...
export default StrategyCTAForm;
