...
const AICTAForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch('/api/send-email', {
        ...
        body: JSON.stringify({ ...formData, captchaToken, formName: 'AI Innovation Lab' })
      });
      if (!res.ok) {
  ...
  return (
    <section className="relative overflow-hidden bg-slate-900 py-20 lg:py-28 font-sans text-white scroll-mt-24 lg:scroll-mt-28" id="ai-cta-form">
          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="space-y-4">
              ...
              <h2 className="text-4xl lg:text-5xl font-bold tracking-tight text-white leading-tight">
                Ready to <span className="text-[#14C1F4] bg-clip-text text-transparent bg-gradient-to-r from-[#14C1F4] to-blue-400">Automate, Build,</span> or Train with AI?
              </h2>
              <p className="text-slate-300 text-lg leading-relaxed font-medium">
                Let's collaborate with our AI Innovation Lab to identify operational automation gaps, train custom models on your datasets, and upskill your engineering teams.
              </p>
            </div>
          </div>
                ...
                {isSubmitted ? (
                  ...
                  <div className="py-16 text-center flex flex-col items-center justify-center min-h-[480px]">
                    ...
                    <p className="text-slate-600 max-w-sm mx-auto text-sm leading-relaxed mb-8">
                      Thank you, <span className="text-[#14C1F4] font-bold">{formData.name}</span>. Our AI Lab experts will review your request for <span className="font-bold text-slate-900">{formData.organization}</span> and reach out to you shortly.
                    </p>
                    <button
                      onClick={() => {
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                      <h3 className="text-xl font-bold text-slate-900">Initiate an AI Discovery Call</h3>
                      <p className="text-xs text-slate-500 mt-1">Please fill in the details below, and our AI experts will connect with you.</p>
                    </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <textarea
                        ...
                        onChange={handleChange}
                        placeholder="Tell us about your automation goals, data sources, or custom model training needs..."
